    ...
    return (
        <div className="homepage-wrap">
            ...
            <div className="section-box" ref={boxDom}>
                ...
                <div
                    className={`section-item ${section === 1 ? 'active' : section > 1 ? 'up' : 'down'
                        }`}
                    style={{ padding: '2vh 0' }}
                >
                    <div className="section-style2">
                        ...
                        <h5 className="title4">
                            公司具备现代数字城市的深厚行业背景，具备平台化的设计环境和强大的研发能力，能够打造出极具竞争力的现代数字城市AI芯片产品。公司具备的芯片方案设计、芯片设计到晶圆制造、封装和测试、解决方案设计完整流程经验，可以有效降低设计风险，缩短设计周期，快速实现量产
                        </h5>
                    </div>
                </div>
                <div
                    className={`section-item ${section === 2 ? 'active' : section > 2 ? 'up' : 'down'
                        }`}
                >
                    <div className="section-style2">
                        <div className="titlebox">
                        ...
                        <div className="arrowbox sw">
                            <div className="leftbox">
                                <h5 className="title4">
                                    世纪励芯是一家专注于半导体芯片设计和应用解决方案研发的公司，为客户提供专业丰富的解决方案和一站式设计服务，可根据客户的需求量身
                                </h5>
                                <div className="bottomline"></div>
                            </div>
                            <div className="rightbox">{/* <img alt="" src={banner}/> */}</div>
                        </div>
                    </div>
                </div>
                <div
                    className={`section-item ${section === 3 ? 'active' : 'down'}`}
                    style={{
